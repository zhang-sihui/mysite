...
class Article(models.Model):
    ...
    _author = models.ForeignKey(Author, on_delete=models.CASCADE,
                                ...
                                verbose_name=translate_message('author'))
    ...
    _category = models.ForeignKey(Category, on_delete=models.CASCADE,
                                  limit_choices_to={'delete': False}, null=True,
                                  verbose_name=translate_message('category'))
...
class File(models.Model):
    ...
    create_date = models.DateTimeField(translate_message('create_date'), default=timezone.now)
    create_user = models.CharField(translate_message('create_user'), max_length=16, default='')
